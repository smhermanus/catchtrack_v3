...
const verticalMenuData = (dictionary: Awaited<ReturnType<typeof getDictionary>>): VerticalMenuDataType[] => [
  // HOME: This is how you will normally render submenu
  {
  ...
  // Permits: This is how you will normally render menu section
  {
    label: dictionary['navigation'].permits,
    isSection: true,
    children: [
      {
        label: dictionary['navigation'].applypermit,
        icon: 'ri-layout-4-line',
        href: '/permits/apply'
      },
      {
        label: dictionary['navigation'].listapplications,
  ...
  // Dashboards: This is how you will normally render menu section
  {
  ...
  // Front Pages: This is how you will normally render menu section
  {
  ...
  // AppsPages: This is how you will normally render menu section
  {
  ...
  // Forms and Tables: This is how you will normally render menu section
  {
  ...
  // Charts and Misc: This is how you will normally render menu section
  {
