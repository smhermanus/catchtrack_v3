        ...
        <DialogContent className='overflow-visible pbs-0 sm:pli-16 sm:pbe-16'>
          ...
          <div className='flex items-center gap-4 flex-col sm:flex-row'>
            <FormControl fullWidth size='small'>
              ...
              >
                <MenuItem value='Basic'>Basic - R950/month</MenuItem>
                <MenuItem value='Standard'>Standard - R2499/month</MenuItem>
                <MenuItem value='Enterprise'>Enterprise - R4499/month</MenuItem>
                <MenuItem value='Company'>Company - R6999/month</MenuItem>
              </Select>
            </FormControl>
