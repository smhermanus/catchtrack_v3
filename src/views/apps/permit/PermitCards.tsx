...
// Component Imports
import PermitDialog from '@components/dialogs/permit-dialog'
      ...
      <Grid container className='bs-full'>
        <Grid item xs={5}>
          <div className='flex items-end justify-center bs-full'>
            <img alt='add-permit' src='/images/illustrations/characters/9.png' height={130} />
          </div>
        </Grid>
        <Grid item xs={7}>
          <CardContent>
    ...
    <>
      <Grid container spacing={6}>
        ...
        <Grid item xs={12} sm={6} lg={4}>
          <OpenDialogOnElementClick element={Card} elementProps={CardProps} dialog={PermitDialog} />
        </Grid>
      </Grid>
    </>
  )
