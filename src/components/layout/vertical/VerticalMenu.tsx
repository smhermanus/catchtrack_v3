...
// MUI Imports  todo: import Chip from '@mui/material/Chip'
...
const VerticalMenu = ({ dictionary, scrollMenu }: Props) => {
  ...
  return (
    ...
    >
      ...
      >
        <MenuItem href={`/${locale}/dashboards/catchtrack`} icon={<i className='ri-home-smile-line' />}>
          {dictionary['navigation'].home}
        </MenuItem>

        <MenuSection label={dictionary['navigation'].permits}>
          <MenuItem href={`/${locale}/permits/apply`} icon={<i className='ri-layout-4-line' />}>
            {dictionary['navigation'].applypermit}
          </MenuItem>
          <MenuItem href={`/${locale}/permits/list`} icon={<i className='ri-checkbox-multiple-line' />}>
            {dictionary['navigation'].listapplications}
          </MenuItem>
        </MenuSection>

        <MenuSection label={dictionary['navigation'].users}>
          <MenuItem href={`/${locale}/users/list`} icon={<i className='ri-layout-4-line' />}>
            {dictionary['navigation'].listusers}
          </MenuItem>
          <MenuItem href={`/${locale}/users/view`} icon={<i className='ri-checkbox-multiple-line' />}>
            {dictionary['navigation'].viewprofile}
          </MenuItem>
          <MenuItem href={`/${locale}/users/tracking`} icon={<i className='ri-checkbox-multiple-line' />}>
            {dictionary['navigation'].tracking}
          </MenuItem>
        </MenuSection>

        <MenuSection label={dictionary['navigation'].submissions}>
          <SubMenu label={dictionary['navigation'].skippers} icon={<i className='ri-bill-line' />}>
            <MenuItem href={`/${locale}/submissions/skippers/history`}>{dictionary['navigation'].history}</MenuItem>
            <MenuItem href={`/${locale}/submissions/skippers/logcatch`}>{dictionary['navigation'].logcatch}</MenuItem>
          </SubMenu>
          <SubMenu label={dictionary['navigation'].monitors} icon={<i className='ri-bill-line' />}>
            <MenuItem href={`/${locale}/submissions/monitors/history`}>{dictionary['navigation'].history}</MenuItem>
            <MenuItem href={`/${locale}/submissions/monitors/auditcatch`}>
              {dictionary['navigation'].auditcatch}
            </MenuItem>
          </SubMenu>
          <SubMenu label={dictionary['navigation'].drivers} icon={<i className='ri-bill-line' />}>
            <MenuItem href={`/${locale}/submissions/drivers/history`}>{dictionary['navigation'].history}</MenuItem>
            <MenuItem href={`/${locale}/submissions/drivers/logshipment`}>
              {dictionary['navigation'].logshipment}
            </MenuItem>
          </SubMenu>
          <SubMenu label={dictionary['navigation'].factorycontrollers} icon={<i className='ri-bill-line' />}>
            <MenuItem href={`/${locale}/submissions/factorycontrollers/history`}>
              {dictionary['navigation'].history}
            </MenuItem>
            <MenuItem href={`/${locale}/submissions/factorycontrollers/logshipment`}>
              {dictionary['navigation'].logshipment}
            </MenuItem>
          </SubMenu>
        ...
        <MenuSection label={dictionary['navigation'].systemsadmin}>
          <SubMenu label={dictionary['navigation'].admin} icon={<i className='ri-home-smile-line' />}>
            ...
            <MenuItem href={`/${locale}/dashboards/ecommerce`}>{dictionary['navigation'].harbours}</MenuItem>
            <MenuItem href={`/${locale}/dashboards/academy`}>{dictionary['navigation'].factories}</MenuItem>
            <MenuItem href={`/${locale}/dashboards/logistics`}>{dictionary['navigation'].trucks}</MenuItem>
            <MenuItem href={`/${locale}/dashboards/logistics`}>{dictionary['navigation'].countries}</MenuItem>
            <MenuItem href={`/${locale}/dashboards/logistics`}>{dictionary['navigation'].outlets}</MenuItem>
            <MenuItem href={`/${locale}/dashboards/logistics`}>{dictionary['navigation'].permits}</MenuItem>
